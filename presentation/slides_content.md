...
- slide: 12
  ...
  body:
    milestones:
      ...
      - {year: "P4", label: "인용\n그래프"}
      - {year: "P5", label: "작성 지원\n참고문헌"}
    takeaway: "향후: 온톨로지 검색확장 · 대용량 색인 엔진"
  source: "v0.6.4 · github.com/grotyx/rag-obsidian"
...
- slide: 13
  ...
  body:
    ...
    status: "현재 v0.6.4 데스크톱 · BRAT 설치 가능 · Community directory 제출 준비 완료"
  ...
  body:
    rows:
      - {q: "SNOMED·MeSH 같은 의학 용어체계도 되나요?",
         a: "MeSH 태그는 PubMed 추가 시 자동. SNOMED 등은 라이선스상 직접 JSON 팩으로 변환해 장착(노트 태깅·IS_A·동의어). 검색 확장 연동은 로드맵."}
      - {q: "수천 편짜리 큰 서재도 버티나요?",
