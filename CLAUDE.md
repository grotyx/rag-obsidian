...
**Version**: 0.4.2 · **Status**: Phase 0–5 + ontology + PubMed/LLM-summary/MeSH + CSL citations + import/export + library utilities + review/security pass (54 integration checks green)
...
npm test               # bundles test/integration.ts (obsidian shim) → live integration suite (54 checks)
```
