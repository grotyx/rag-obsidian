...
| GitHub release tag | `0.7.0` — exactly the manifest version, without a `v` prefix |
...
3. Create the exact GitHub tag and release matching the current `manifest.json` version (`0.7.0`
